...
!(function (e) {
  ...
  const t = { api: 'http://localhost:3000', frontend: 'http://localhost:8080' },
    o = {
      api: 'https://api.gameshift.dev',
      frontend: 'https://app.gameshift.dev',
    };
  function getUrls(e = !1) {
    return { api: e ? t.api : o.api, frontend: e ? t.frontend : o.frontend };
  }
  const n = !0;
  var s;
  ...
  class Storefront {
    ...
    validateApiKey() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!t.ok)
          throw (
            ((this.isApiKeyValid = !1),
            new Error(`API validation failed with status ${t.status}`))
          );
        const o = yield t.json();
        if ((console.log('validateApiKey result', o), !o.isValid))
          throw (
            (console.error('validateApiKey error', o.error),
            (this.isApiKeyValid = !1),
            new Error(o.error || 'Invalid API key'))
          );
    ...
    getSku(e) {
      return __awaiter(this, void 0, void 0, function* () {
        return (function (e, t) {
          return __awaiter(this, void 0, void 0, function* () {
            const { api: o } = getUrls(n),
              s = yield fetch(`${o}/nx/storefront/skus/${t}`, {
                method: 'GET',
    ...
    purchaseSkuImmediately(e) {
      return __awaiter(this, void 0, void 0, function* () {
        const { api: t } = getUrls(n),
          o = yield fetch(`${t}/internal/storefront/skus/${e.skuId}/purchase`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
        ...
        return new Promise((t, o) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            const messageHandler = (e) => {
              var a;
              if (e.origin === `${getUrls(n).frontend}`)
                try {
                  const n =
                    'string' == typeof e.data ? JSON.parse(e.data) : e.data;
                  'PaymentComplete' === n.type ||
                  ('iframe-result' === n.type &&
                    'completed' ===
                      (null === (a = n.result) || void 0 === a
                        ? void 0
                        : a.status))
                      ...
                      setTimeout(() => {
                        document.body.removeChild(s),
                          ...
                          t({
                            success: !0,
                            status: 'completed',
                            data: 'PaymentComplete' === n.type ? n : n.result,
                          });
                      }, 300))
                    : console.log(
